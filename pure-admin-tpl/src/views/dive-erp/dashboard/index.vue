<template>
  <div class="dashboard-screen min-h-screen text-white p-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 bg-white/10 rounded-xl p-6 backdrop-blur">
        ...
        <div v-if="loadingTrips" class="flex justify-center py-12 text-white/80">{{ t("diveErp.dashboard.loading") }}</div>
            ...
            <div>
              ...
              <div class="flex flex-wrap gap-3">
                <div
                  ...
                  :key="r.id"
                  class="w-20 h-20 rounded-xl flex items-center justify-center font-bold text-base shadow-md"
...
defineOptions({ name: "DiveDashboard" });
...
async function loadTrips() {
  ...
  try {
    ...
    // http 拦截器已返回 response.data，res 即后端 body：{ success, date, islands }
